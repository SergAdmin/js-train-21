...
class Performance {
  ...
  constructor(band, location, date) {
    (this.#band = band), (this.#location = location), (this.#date = date);
  }
  get band() {
    return this.#band;
  }
...
class Concert extends Performance {
  ...
  constructor(band, location, date, ticketPrice) {
    super(band, location, date), (this.#ticketPrice = ticketPrice);
  }
  get ticketPrice() {
...
//console.log(guitarist instanceof Musician);
